...
export default function RecipeScreen({ route, navigation }) {
  ...
  const generateRecipe = async () => {
    try {
      ...
      // Add timeout to prevent infinite loading - increased for AI recipe generation
  ...
  if (loading) {
    ...
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingSubtext}>Claude AI is creating detailed, {selectedSkillLevel}-level instructions (this may take 15-30 seconds)</Text>
